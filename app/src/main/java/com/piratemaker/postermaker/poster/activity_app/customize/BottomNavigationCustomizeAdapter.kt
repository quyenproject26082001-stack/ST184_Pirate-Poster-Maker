...
import com.piratemaker.postermaker.poster.core.extensions.dp
import com.piratemaker.postermaker.poster.core.extensions.setMargins
...
import com.piratemaker.postermaker.poster.databinding.ItemBottomNavigationBinding
...
//            }
            ...
            if (item.isSelected) {
                ...
                cvContent.setBackgroundResource(R.drawable.bg_item_customize_selected)
                ...
                imvImage.setBackgroundColor(Color.TRANSPARENT)
                cvContent.setBackgroundResource(R.drawable.bg_item_customize_unselected)
                cvContent.translationZ = 0f
                cvContent.translationY = 0f
            }
