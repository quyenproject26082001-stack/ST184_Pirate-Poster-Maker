package com.piratemaker.postermaker.poster.core.custom.drawview
...
import com.piratemaker.postermaker.poster.core.draw.DrawDraw
import com.piratemaker.postermaker.poster.core.draw.DrawableDraw
import com.piratemaker.postermaker.poster.core.draw.TextDraw
import com.piratemaker.postermaker.poster.core.listener.listenerdraw.BitmapDrawIcon
import com.piratemaker.postermaker.poster.core.listener.listenerdraw.DeleteEvent
import com.piratemaker.postermaker.poster.core.listener.listenerdraw.FlipEvent
import com.piratemaker.postermaker.poster.core.listener.listenerdraw.OnDrawListener
import com.piratemaker.postermaker.poster.core.listener.listenerdraw.ZoomEvent
...
//                }
    ...
    private fun resizeDrawableToDp(drawable: Drawable, sizeDp: Int): Drawable {
    ...
    private fun setupDefaultIcons() {
        ...
        val flipIcon = BitmapDrawIcon(
            resizeDrawableToDp(ContextCompat.getDrawable(context, R.drawable.ic_flip_cs)!!, 20), DrawKey.RIGHT_TOP
        )
